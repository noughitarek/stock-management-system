                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <select class="form-control" id="products_funding" name="products_funding">
                            ...
                            <option value="{{$product->id}}" {{old('products_funding')??$purchase->products_funding==$product->id?'selected':''}}>{{$product->name}}</option>
                            @endforeach
                        </select>
                        @error('name')
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-control" id="tests_funding" name="tests_funding">
                            ...
                            <option value="{{$test->id}}" {{old('tests_funding')??$purchase->tests_funding==$test->id?'selected':''}}>{{$test->name}}</option>
                            @endforeach
                        </select>
                        @error('name')
                            <div class="text-danger">{{ $message }}</div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="total_amount" name="total_amount" placeholder="Ex: 38000" value="{{old('total_amount')??$purchase->total_amount}}" required>
                        @error('total_amount')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>

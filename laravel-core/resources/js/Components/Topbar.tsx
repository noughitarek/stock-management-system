...
const Topbar: React.FC<TopbarProps> = ({ breadcrumb, user }) => {
    ...
    return (
        <div className="top-bar -mx-4 px-4 md:mx-0 md:px-0">
            ...
            <Dropdown>
                <Dropdown.Trigger>
                    <div className="dropdown-toggle dropdown notification notification--bullet cursor-pointer me-4" role="button"> 
            ...
            <Dropdown>
                ...
                <div className='dropdown-menu w-56 show'>
                    <ul className="dropdown-content bg-primary text-white">
                        ...
                        <li>
                            <a href="" className="dropdown-item hover:bg-white/5"> <UserIcon className="w-4 h-4 mr-2"/> Profile </a>
                        </li>
                        <li>
